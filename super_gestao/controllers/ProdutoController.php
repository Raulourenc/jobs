...
class ProdutoController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Item $produto, Fornecedor $fornecedor)
    {
        $regras = [
            'nome' => 'required|min:3|max:40',
            'descricao' => 'required|min:3|max:2000',
        ...
        return redirect()->route('produto.show', ['produto' => $produto->id, 'fornecedores' => $fornecedor->id]);
    }
