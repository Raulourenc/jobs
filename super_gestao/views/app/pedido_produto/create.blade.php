    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina" >
            ...
            <div style="width: 30%; margin-left: auto; margin-right: auto; ">
               ...
               <table border="1" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Data de Incluão do item no pedido</th>
               ...
               @component('app.pedido_produto._components.form_create', ['pedidoProduto' => $produto->pivot->id, 'pedido' => $pedido, 'produtos' => $produtos])
               @endcomponent
            </div>
        </div>
