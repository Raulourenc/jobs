...
@section('conteudo')
    ...
    <div class="conteudo-pagina">
        ...
        <div class="informação-pagina">
                    ...
                    @foreach ($produtos as $produto)
                        <tr>
                            ...
                            <td>
                                ...
                                <!--<a href="">Excluir</a>-->
                                <a href="#" onclick="document.getElementById('form_{{$produto->id}}').submit()">Excluir
                                </form>
                            </td>
            ...
            Exibindo  {{ $produtos->count() }} produtos de um total {{ $produtos->total() }} (de {{ $produtos->firstItem() }} a {{ $produtos->lastItem() }})
            </div>
        </div>
