...
@section('conteudo')
    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
                    ...
                    @foreach ($pedidos as $pedido)
                        <tr>
                            ...
                            <td>
                                ...
                                <!--<a href="">Excluir</a>-->
                                <a href="#" onclick="document.getElementById('form_{{$pedido->id}}').submit()">Excluir
                                </form>
                            </td>
            ...
            Exibindo  {{ $pedidos->count() }} pedidos de um total {{ $pedidos->total() }} (de {{ $pedidos->firstItem() }} a {{ $pedidos->lastItem() }})
            </div>
        </div>
